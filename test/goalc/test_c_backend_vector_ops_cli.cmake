...
set(GENERATED_C "${OUTPUT_DIR}/vec.c")
set(GENERATED_H "${OUTPUT_DIR}/vec_generated.h")
set(REPORT "${OUTPUT_DIR}/vec.report.txt")
set(TEST_BINARY "${OUTPUT_DIR}/vector_ops_c_backend_test")
...
execute_process(
  COMMAND "${GOALC_CBACKEND}"
          ...
          "${PROJECT_ROOT}/test/goalc/aot/vector_ops_test.gc"
  RESULT_VARIABLE EMIT_RESULT)
if(NOT EMIT_RESULT EQUAL 0)
  message(FATAL_ERROR "goalc-cbackend failed on the vector-operation fixture")
endif()

file(READ "${REPORT}" REPORT_TEXT)
if(REPORT_TEXT MATCHES "FAILED")
  message(FATAL_ERROR "goalc-cbackend could not translate the vector-operation fixture:\n${REPORT_TEXT}")
endif()
...
execute_process(
  COMMAND "${C_COMPILER}"
          ...
          "${PROJECT_ROOT}/test/goalc/aot/vector_ops_c_backend_test.c"
...
if(NOT HOST_RUN_RESULT EQUAL 0)
  message(FATAL_ERROR "The PS2 vector operations produced wrong values in the generated C")
endif()
