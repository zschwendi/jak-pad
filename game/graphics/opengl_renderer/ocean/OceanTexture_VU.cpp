...
void OceanTextureVu::xgkick_PC(Vf* src) {
...
void OceanTextureVu::run_L1_PC_jak2() {
  //  L1:
  //  lq.xyzw vf14_startx, 988(vi00)    |  maxw.xyzw vf01_ones, vf00, vf00
  vu.startx = Vf(m_texture_constants.start);
  //  lq.xyzw vf02_offset, 989(vi00)
...
void OceanTextureVu::run_L2_PC_jak2() {
  //  L2:
  //  xtop vi05_in_ptr
  vu.in_ptr = swap_vu_upload_buffers();
  //  mtir vi06_dbuf_write, vf04_dbuf.x
...
void OceanTextureVu::run_L3_PC_jak2() {
  Vf base_pos;  // vf15
  u16 loop_idx;
...
void OceanTextureVu::setup_renderer() {
  m_pc.vtx_idx = 0;
}
