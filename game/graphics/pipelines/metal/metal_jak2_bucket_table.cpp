...
static_assert(count_behavior(kTable, Jak2MetalBucketBehavior::DeferredSkip) == 151);
...
static_assert(count_behavior(kTable, Jak2MetalBucketBehavior::HostTextureUpload) == 14);
